...
<div id="header1-1"><!-- DIV PRINCIPAL **INICIO** -->
    <div class="container"><!-- MAIN -->
        <!-- DIV DE LA INFORMACION **INICIO** -->
            <div class="span-4">
                <?php
				echo anchor('usuarios/perfil',
                    img(array('src'=>'statics/img/logo-blanco.jpg',
                              'width'=>'160',
                              'height'=>'68','onclick'=>"Enviar('".base_url()."index.php/planesusuarios/ver/".$this->session->userdata('id')."','#texto-menu');"))); ?>
            </div>
            <div class="span-14">
                ...
                <div class="span-8" style="margin-left: 0px">
                    ...
                    <span style="color: #FFFFFF">
                        <?php echo anchor('developers/index',
                                          'API',
                                          array('id'=>'', 'style'=>'text-decoration: none; color: #FFFFFF; margin-left: 0px; margin-right: 10px')); ?>
                    </span>
                    <span style="color: #FFFFFF; margin-right: 10px">
                        |
                    </span>
