<?php
/**
 * Vista la cual se mostrara cuando el usuario
 * desee ver todos los retos que haya hecho
 * determinado negocio
 **/
?>
...
<div class="span-14 last" style="margin-top: 20px" >
    ...
    <?php echo anchor('retosnegocios/ver/'.$id, '', array('id'=>'redirectMain', 'style'=>'display: none')); ?>
    <?php echo anchor('negocios/get_pulzos_nuevos/'.$id, '', array('id'=>'returnUrl', 'style'=>'display: none')); ?>
    <?php echo anchor('pulzos/ver/'.$this->session->userdata('idN'),'hola',array('id'=>'enlance', 'style'=>'display: none')); ?>
    <!--div class="soft-header" style="margin-top: 15px; margin-right: 30px; margin-bottom: 5px;">
        Retos de <?php $var = get_name_company($id); echo $var->negocioNombre; ?>
    </div --><?php $b=0;?>
    <?php $valores = obtain_array_company($retos); ?>
                            ...
                            <div id="duracion<?php echo $b;?>"></div>
                                <script language="javascript">
		    						...
		    						var nueva=auxf[0]+" "+auxf[1]+","+auxf[2]+" "+auxf[3]+":"+auxf[4]+":00";
						    			...
						    			maniana1=new Date();
							    		if(maniana<=maniana1){start(nueva,tiempotras,'countdowncontainerrr1<?php echo $b;?>');}
								    
                                </script>
                                <div id="countdowncontainerrr1<?php echo $b;?>" style=" background:#DDEACF;  border:0px; border: 0px solid #399210; color:#006600; width:250px; height:27px;">
    ...
    <div class="span-14" style="display: none">
        ...
        <?php echo anchor('retosnegocios/get_last_number_challenge/'.$id, '', array('style'=>'display:', 'id'=>'urlGet')); ?>
    </div>
    <div class="span-14">
        <div class="prepend-12">
            <?php echo anchor('retosnegocios/ver_siguientes/'.$id,
                              'Ver mas',
