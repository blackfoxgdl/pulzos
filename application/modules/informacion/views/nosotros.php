...
<div class="container" id="f-footer">
    ...
    <div class="span-6" id="menu"><!-- menu -->
        ...
        <div class="span-5">
            <?php echo anchor('informacion/contacto','Contacto', array('style'=>'text-decoration:none;
                                                                                 color:#EF3F69;')); ?>
        </div>
        <div class="span-1 last">&nbsp;</div>
        <div class="span-5">
            <?php echo anchor('informacion/condiciones','Condiciones',array('style'=>'text-decoration:none;
                                                                                      color:#EF3F69;')); ?>
        </div>
        <div class="span-1 last">&nbsp;</div>
        <div class="span-5">
            <?php echo anchor('informacion/prensa','Prensa',array('style'=>'text-decoration:none;
                                                                             color:#EF3F69;')); ?>
        </div>
        <div class="span-1 last">&nbsp;</div>
        <div class="span-5">
<?php echo anchor('informacion/blog','Blog',array('style'=>'text-decoration:none;
                                                            color:#EF3F69;')); ?>
        </div>
        <div class="span-1 last">&nbsp;</div>
        <div class="span-5">
            <?php echo anchor('informacion/api','API',array('style'=>'text-decoration:none;
                                                                       color:#EF3F69;')); ?>
        </div>
        <div class="span-1 last">&nbsp;</div>
        <div class="span-5">
            <?php echo anchor('informacion/ayuda','Ayuda',array('style'=>'text-decoration:none;
                                                                           color:#EF3F69;')); ?>
        </div>
    </div><!-- menu -->
