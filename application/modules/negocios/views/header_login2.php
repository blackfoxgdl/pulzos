            ...
            <div class="span-11 last" id="header-menu" style="margin-top: 10px">
                ...
                <div style="float: left; margin-top: 9px; width: 70px">
                    <?php echo anchor('negocios/perfil',
                                      'Mi perfil', array('style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF', 'id'=>'miPerfil','onclick'=>"Enviar1('".base_url()."index.php/negocios/miperfil/','#texto-menu');")); ?>
                </div>
                <div style="float: left; margin-top: 8px">
                    |
                </div>
                <div style="float: left; margin-top: 9px; width: 75px; color: #FFFFFF">
                    
                    <?php echo anchor('negocios/perfil',
                                      'Alianzas', array('style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF', 'id'=>'miPerfil','onclick'=>"Enviar1('".base_url()."index.php/alianzassociales/index/','#texto-menu');")); ?>
                </div>
                <div style="float: left; margin-top: 8px">
                    |
                </div>
                ...
                <div style="margin-top: 9px; float: left">
                    <?php echo anchor('negocios/perfil',
                                      'Notificaciones', array('style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF', 'id'=>'notificaciones-empresa','onclick'=>"Enviar1('".base_url()."index.php/notificaciones/index/','#texto-menu');")); ?>
                </div>
            </div>
        </div>
        <div class="span-5">
