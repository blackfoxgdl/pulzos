...
function checkData()
{
    ...
    {
        $("#confirmPassM").text('Please, confirm the password').show();
        totalesE++;
    }
    else
    {
        if($("#passwordConfirm").val() == $("#passwordUsuario").val())
        {
            $("#confirmPassM").hide();
        }
        else
        {
            $("#confirmPassM").text('The password dont match').show();
            totalesE++;
        }
    }
    ...
    if($("#zipCode").val() == '')
    {
        $("#zipCodeM").text('Please, type the zip code').show();
        totalesE++;
    }
    else
    {
    ...
    if($("#cityS").val() == '')
    {
        $("#citisM").text('Please, type the city').show();
        totalesE++;
    }
    else
    {
...
<div class="container colorbody">
    ...
    <div class="prepend-12"><!-- INICIA LA FORMA DE REGISTRO -->
        <div class="span-11 last" style="margin-top: -12px">
            <?php echo form_open('negocios/crear', array('id'=>'registro-negocio', 'onsubmit'=>'return checkData();')); ?>
                ...
                <div class="span-10 last separacion2">
                    ...
                    <div class="span-6 last">
                        <?php echo form_input(array('id'=>'address2',
                                                    'class'=>'inputRegistro',
                                                    'name'=>'Negocio[negocioAddress2]')); ?>
                    </div>
                </div>
                <div class="span-10 last separacion2">
                    <div class="span-4 first textForm">
                    ...
                    <div class="span-6 last">
                        <?php echo form_input(array('id'=>'zipCode',
                                                    'class'=>'inputRegistro',
                                                    'name'=>'Negocio[negocioZipCode]')); ?>
                        <br />
                        <span style="display: none; color: #FFFFFF" id="zipCodeM"></span>
                    </div>
                </div>
                <div class="span-10 last separacion2">
                    <div class="span-4 first textForm">
                    ...
                    <div class="span-6 last">
                        <?php echo form_input(array('id'=>'cityS',
                                                    'class'=>'inputRegistro',
                                                    'name'=>'Negocio[negocioCity]')); ?>
                        <br />
                        <span style="color: #FFFFFF; display: none" id="citisM"></span>
                    </div>
                </div>
                <div class="span-10 last separacion2">
                    <div class="span-4 first textForm">
                    ...
                    <div class="span-6 last">
                        <select name="Negocio[negocioPais]">
                ...
                <?php /*<div class="span-10 last separacion">
                    <?php $giros = 'id="giro"
                                    style="width:180px;"
                                    value=""' ; ?>
                    <div class="span-4 first textForm">
                ...
                <div class="span-10 last separacion2">
                    ...
                    <div class="span-6 last">
                        <?php echo form_password(array('id'=>'passwordConfirm',
                                                       'class'=>'inputRegistro',
                                                       'name'=>'Negocio[confirmPassword]')); ?>
                        <br />
                        <span style="display: none; color: #FFFFFF" id="confirmPassM"></span>
                    </div>
                </div>
                <?php /*<div class="span-10 last separacion">
                    <div class="span-4 first textForm">
