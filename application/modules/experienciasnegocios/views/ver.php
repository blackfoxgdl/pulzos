<?php
/**
 * Vista que mostrara todos los pulzos con
 * sus respectivos datos con los cuales
 * se podran ver ya todos con un scroll bar
 * que se creara
 **/
?>
...
<?php echo anchor('negocios/get_pulzos_nuevos/'.$id, '', array('id'=>'reloadUrl','style'=>'display:none')); ?>
<?php echo anchor('experienciasnegocios/ver/'.$id, '', array('id'=>'redirectMain', 'style'=>'display: none')); ?>
<div class="span-14 last" style="margin-top: 20px">
    <?php $valores = obtain_array_company($experiencias); ?>
    ...
    <div class="span-14" style="display: none">
        ...
        <?php echo anchor('experienciasnegocios/see_next_ten_data/'.$id, '', array('style'=>'', 'id'=>'urlGet')); ?>
    </div>
    <div class="span-14">
        <div class="prepend-12 last">
            <?php echo anchor('experienciasnegocios/ver_siguientes/'.$id,
                              'Ver mas',
