<?php
/**
 * Metodo o vista que se usa para mostrar
 * las experiencias de forma individual 
 * para mostrarlas a los usuarios y empresas
 **/
?>
...
$(".eliminarPulzo").click(function(event){
    event.preventDefault();
    urlDelete = $(event.currentTarget).attr("href");
    urlRedirect = $("#redirecciona").attr("href");
    $.get(urlDelete);
    $("#texto-menu").load(urlRedirect);
});
</script>
<?php echo anchor('experienciasnegocios/ver/'.$experiencia->negocioId, '', array('id'=>'redirecciona', 'style'=>'display: none')); ?>
<?php echo anchor('experienciasnegocios/ver_experiencia/'.$experiencia->pulzoId, '', array('style'=>'display: none', 'id'=>'returnLoad')); ?>
<div class="span-14 last" style="margin-top: 20px"><!-- MAIN **INICIO** -->
        ...
        <div class="span-14" style="width: 524px"><!-- DIV DEL CUERPO **INICIO** -->
            ...
            <div class="interlineado span-12 last" style="margin-left: 10px; word-wrap: break-word"><!-- DIV DEL CUERPO DEL MENSAJE **INICIO** -->
                <span class="pulzos_titulo1">
                    <?php echo anchor('negocios/perfil/'.$experiencia->negocioId,
            ...
            <div id="aviso-legal-<?php echo $experiencia->pulzoId; ?>" style="display: none">
