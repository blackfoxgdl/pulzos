        ...
        <!--div class="header_profile" --><!-- DIV DE LA INFORMACION **INICIO** -->
            ...
            <div class="span-14">
                ...
                <div class="span-13 last" id="header-menu" style="margin-top: 10px;">
                    ...
                    <div style="float: left; margin-top: 9px; width: 95px">
                        <?php echo anchor('usuarios/perfil',
                                          'Invitaciones', 
                                           array('id'=>'invitacion-user', 'style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF','onclick'=>"Enviar('".base_url()."index.php/invitacionespersonales/index/".$this->session->userdata('id')."','#texto-menu');")); ?>
