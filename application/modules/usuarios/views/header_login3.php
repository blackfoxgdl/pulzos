...
function update() {
    urlReloadFourth = $("#reloadSecond").attr("href");
    $.ajax({
        type: 'GET',
        url: urlReloadFourth,
        timeout: 5000,
            ...
            <div class="span-4">
				...
				echo anchor('usuarios/perfil',
                    img(array('src'=>'statics/img/logo-blanco.jpg',
                              'width'=>'160',
                              'height'=>'68','onclick'=>"Enviar1('".base_url()."index.php/money/index/".$this->session->userdata('id')."','#texto-menu');"))); ?>
            </div>
            <div class="span-14">
                ...
                <div class="span-13 last" id="header-menu" style="margin-top: 10px;">
                    <div style="float: left; width: 60px; margin-top: 8px">
                        <?php echo anchor('#',//'usuarios/perfil',
                                          'Inicio', array('style'=>'margin-left: 15px; text-decoration: none; color: #FFFFFF', 'id'=>'inicio','onclick'=>"Enviar1('".base_url()."index.php/planesusuarios/ver/".$this->session->userdata('id')."','#texto-menu');")); ?>
                    </div>
                    ...
                    <div style="float: left; width: 70px; margin-top: 9px">
                        <?php echo anchor('#',//'usuarios/perfil',
                                          'Mi perfil', array('style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF', 'id'=>'mi-perfil','onclick'=>"Enviar1('".base_url()."index.php/planesusuarios/mis_planes/".$this->session->userdata('id')."','#texto-menu');")); ?>
                    </div>
                    <div style="float: left; margin-top: 8px">
                        |
                    </div>
                    ...
                    <div style="float: left; margin-top: 9px; width: 85px">
                        ...
                        <?php echo anchor('#',
                                          'Mensajes',
                                          array('id'=>'inbox-user', 'style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF','onclick'=>"Enviar1('".base_url()."index.php/inboxusuarios/index/".$this->session->userdata('id')."','#texto-menu');")); ?>
                    ...
                    <div style="float: left; margin-top: 9px; width: 110px">
                        <?php echo anchor('#',
                                          'Notificaciones', 
                                          array('style'=>'text-decoration: none; margin-left: 15px; color: #FFFFFF', 'id'=>'notificacion-user','onclick'=>"Enviar1('".base_url()."index.php/notificaciones/index/".$this->session->userdata('id')."','#texto-menu');")); ?>
                    ...
                    <div style="float: left; margin-top: 9px">
                        <?php echo anchor('#',
                                          'Mi cartera',
                                          array('style'=>'text-decoration: none; color: #FFFFFF; margin-left: 10px', 'id'=>'cartera-user', 'onclick'=>"Enviar1('".base_url()."index.php/money/index/'".$this->session->userdata('id')."','#texto-menu');")); ?>
                    </div>
                </div>
            </div>
            <div class="span-5">
                <div class="span-6 last" style="width: 28px; margin-top: 10px; margin-left: 14px; margin-bottom: 16px">
                    <div class="span-6" align="right">
                        ...
                        <?php echo anchor('#',
                                         $localidades2->nombre, 
                                          array('style'=>'text-decoration: none;margin-right: 5px; color: #999999;','id'=>'ubicacion-user','onclick'=>"Enviar1('".base_url()."index.php/usuarios/ubicacion_usuario/".$this->session->userdata('id')."','#texto-menu');")); ?>
                        <?php }?>
                ...
                <div class="span-6" style="border: 1px solid #CDCDCD; width: 215px; margin-left: 25px">
                    ...
                    <?php echo form_open('usuarios/busqueda', array('id'=>'FormBusqueda')); ?>
                        ...
                        <?php echo form_submit(array('id'=>'buscarA',
                                                     'class'=>'buscar','onclick'=>"Enviar1('".base_url()."index.php/usuarios/busqueda/Buscar','#texto-menu');")); ?>
                    <?php echo form_close(); ?>
                </div>
            </div>
            ...
            <div class="span-4 last">
                <div class="span-8" style="margin-left: 2px">
                    <span style="color: #FFFFFF; margin-left: 80px">
                        <?php echo anchor('usuarios/perfil',
                                          'Editar Cuenta', 
                                          array('class'=>'middle-menu-link1', 'id'=>'top-menu-editar-datos', 'style'=>'margin-right: 10px; text-decoration: none; color: #FFFFFF','onclick'=>"Enviar1('".base_url()."index.php/usuarios/editar_datos','#texto-menu');")); ?>
                    </span>
